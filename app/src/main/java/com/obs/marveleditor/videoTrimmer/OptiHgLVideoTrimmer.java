...
public class OptiHgLVideoTrimmer extends FrameLayout {
  ...
  private void setUpListeners() {
    ...
    mRangeSeekBarView.addOnRangeSeekBarListener(
        new OptiOnRangeSeekBarListener() {
          @Override
    ...
    mHolderTopView.setOnSeekBarChangeListener(
  ...
  private void setTimeFrames() {
    ...
    mTextTimeFrame.setText(
        String.format(
            "%s %s - %s %s",
            stringForTime(mStartPosition), seconds, stringForTime(mEndPosition), seconds));
  }
  ...
  /**
   * Set the maximum duration of the trimmed video. The trimmer interface wont allow the user to set
   * duration longer than maxDuration
   *
  ...
  private static class MessageHandler extends Handler {
    ...
    @NonNull private final WeakReference<OptiHgLVideoTrimmer> mView;
